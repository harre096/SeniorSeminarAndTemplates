...
\begin{center}
  ...
  \includegraphics<2>[width=.8\linewidth,height=.7\textheight,keepaspectratio]{figures/engarde/states1.png}%%we'll start with No Power (flip)
\end{center}
\end{frame}
...
\frametitle{EnGarde State Diagram}
\begin{center}
  \includegraphics[width=.8\linewidth,height=.7\textheight,keepaspectratio]{figures/engarde/states3.png}%%show at end of decode
\end{center}
\end{frame}
