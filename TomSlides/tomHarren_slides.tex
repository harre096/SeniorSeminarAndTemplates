...
\frametitle{NFC on Mobile Phones}
  ...
  \begin{block}{\circled{1}~~Phones can act as readers}\centering
      \includegraphics[width=\linewidth,height=0.5\textheight,keepaspectratio]{figures/hardy.png}
      \begin{itemize}
...
\frametitle{NFC on Mobile Phones}
  ...
  \begin{block}{\circled{2}~~Phones can emulate tags}\centering
      \includegraphics[width=\linewidth,height=0.5\textheight,keepaspectratio]{figures/ApplePay.jpg}
      \begin{itemize}
...
\frametitle{Phones can communicate peer-to-peer}
  ...
  \begin{block}{\circled{3}~~Phones can communicate as peers}\centering
      \includegraphics[width=\linewidth,height=0.5\textheight,keepaspectratio]{figures/peer.jpg}
      \begin{itemize}
