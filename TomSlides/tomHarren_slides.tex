...
\frametitle{Eavesdropping}
  ...
  \begin{columns}[T]
    \begin{column}{.5\textwidth}\centering
        % \vspace{3mm}
         \includegraphics[width=\linewidth,height=0.6\textheight,keepaspectratio]{figures/eavesFlicker.jpg}
    \end{column}
    \begin{column}{.5\textwidth}
        \begin{block}{Eavesdropping}
          \begin{itemize}
              ...
              \pause
              \item{Card number, expiration, bank name, and iCVV can be obtained}
              \pause
              \item{Attack is feasible requiring an inexpensive tag and radio}
              \includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{figures/CCeaves.png}
              \pause
              \item{Passive tags are smallest and cheapest}
              \pause
            \end{itemize}
