...
\frametitle{Experimental Evaluation of EnGarde}
  ...
  \begin{block}{Jamming}
    \begin{itemize}
      ...
      \pause
      \vspace{1mm}
      \item{Decoding was also successful in decoding a malicious tag to URL \textit{http://malware}}
      \pause
      \vspace{1mm}
...
\frametitle{Conclusion}
  ...
  \begin{block}{Conclusion}
    \begin{itemize}
      ...
      \pause
      \vspace{1mm}
      \item{NCF ticking is a viable option for the future, but NFC data transfer speeds need improvement}
      \pause
      \vspace{1mm}
      \item{EnGarde's defense seems strong, but we note that its defense is only as strong as the blocking rules it has}
    \end{itemize}
